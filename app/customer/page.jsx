  ...
  return (
    ...
    <main className="relative min-h-screen bg-black text-white overflow-hidden">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8 pt-24 pb-24 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              ...
              <Link
                ...
                className="bg-purple-600 hover:bg-purple-700 px-6 py-3 rounded-lg font-semibold shadow-lg shadow-purple-900/40 transition"
              >
                Jelajahi Katalog
              </Link>
          ...
          >
            ...
            <Image
              ...
              height={420}
              priority
              className="drop-shadow-[0_0_70px_rgba(168,85,247,0.7)]"
            />
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <motion.div
            ...
            className="grid grid-cols-1 md:grid-cols-3 border border-purple-800/60 rounded-xl overflow-hidden backdrop-blur"
          >
